    ...
    <div className="py-24 sm:py-28 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div>
                ...
                <div className="space-y-2 mb-6">
                  <div className="flex items-center justify-between">
                    <h2 className="text-2xl font-black text-[#111111]">{plan.name}</h2>
      ...
      <div className="p-8 rounded-3xl bg-white border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xs">
        <div className="flex items-center gap-4 text-left">
          ...
          <div>
            <h3 className="text-base font-bold text-[#111111]">Have questions about pricing or timeline?</h3>
        ...
        <Link
          to="/contact"
          className="px-6 py-3 rounded-full bg-[#111111] hover:bg-[#2563EB] text-xs font-bold text-white whitespace-nowrap transition cursor-pointer shadow-xs"
        >
          Contact Our Team
        </Link>
      </div>
