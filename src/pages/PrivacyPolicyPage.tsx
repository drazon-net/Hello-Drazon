      ...
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-md space-y-10 text-slate-700 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-[#111111]">1. Commitment to Data Protection</h2>
          </div>
          <p>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-[#111111]">2. Information We Collect</h2>
          </div>
          <p>We collect information in three primary ways:</p>
          <ul className="list-disc pl-5 space-y-2 text-slate-600">
            <li>
              <strong className="text-[#111111]">Information You Provide Directly:</strong> When submitting forms or requesting an instant AI proposal, we collect your name, business name, email address, phone number, and project specifications.
            </li>
            <li>
              <strong className="text-[#111111]">Project & Asset Submissions:</strong> Logos, copy assets, branding guidelines, and domain credentials provided to execute web development or maintenance contracts.
            </li>
            <li>
              <strong className="text-[#111111]">Automated Technical Data:</strong> Browser type, IP address, device telemetry, referral sources, and interaction data collected via performance telemetry cookies.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-[#111111]">3. How We Use Your Information</h2>
          </div>
          <p>Collected data is strictly used for legitimate business operations:</p>
          <div className="grid sm:grid-cols-2 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
              <h3 className="font-bold text-[#111111] text-xs uppercase tracking-wider mb-1">Service Execution</h3>
              <p className="text-xs text-slate-600">Delivering custom web development, UI/UX prototypes, and ongoing maintenance.</p>
            </div>
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
              <h3 className="font-bold text-[#111111] text-xs uppercase tracking-wider mb-1">AI Proposal Generation</h3>
              <p className="text-xs text-slate-600">Generating tailored scope breakdowns, feature roadmaps, and instant estimates.</p>
            </div>
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
              <h3 className="font-bold text-[#111111] text-xs uppercase tracking-wider mb-1">Client Communication</h3>
              <p className="text-xs text-slate-600">Sending project updates, invoice receipts, and priority technical support alerts.</p>
            </div>
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
              <h3 className="font-bold text-[#111111] text-xs uppercase tracking-wider mb-1">Security & Fraud Prevention</h3>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-[#111111]">4. AI Processing & Asset Security</h2>
          </div>
          <p>
        ...
        <section className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-[#111111]">5. Your Data Rights</h2>
          </div>
        ...
        <section className="space-y-3 pt-4 border-t border-slate-200">
          <h2 className="text-xl font-bold text-[#111111]">6. Contact Our Privacy Lead</h2>
          <p>
          ...
          <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-[#111111]">Official Privacy Inquiry Email</p>
