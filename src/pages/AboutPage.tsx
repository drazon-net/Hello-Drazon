    ...
    <div className="py-24 sm:py-28 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
          Building Digital Presence For <span className="text-emerald-gradient">Modern Businesses</span>
        </h1>
      </div>
      ...
      <div className="space-y-6 mb-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 space-y-3 hover:border-emerald-300 hover:shadow-md transition shadow-sm">
            ...
            <h3 className="text-lg font-bold text-slate-900">Professional Solutions</h3>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 space-y-3 hover:border-emerald-300 hover:shadow-md transition shadow-sm">
            ...
            <h3 className="text-lg font-bold text-slate-900">Modern Design</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 space-y-3 hover:border-emerald-300 hover:shadow-md transition shadow-sm">
            ...
            <h3 className="text-lg font-bold text-slate-900">Quality Service</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="p-8 sm:p-10 rounded-2xl bg-white border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm">
        <div className="space-y-2 text-center sm:text-left">
          <h3 className="text-xl font-bold text-slate-900">Ready to take your business online?</h3>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            to="/contact"
            className="px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-white bg-[#10B981] hover:bg-[#059669] rounded-xl shadow-md shadow-[#10B981]/20 transition cursor-pointer"
          >
            Contact Drazon
          </Link>
          <button
            onClick={onOpenProposal}
            className="px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-slate-800 bg-slate-100 hover:bg-slate-200 rounded-xl border border-slate-200 transition cursor-pointer"
          >
            Get Proposal
          </button>
        </div>
